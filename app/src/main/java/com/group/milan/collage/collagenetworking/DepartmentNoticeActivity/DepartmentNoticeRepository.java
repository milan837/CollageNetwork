...
public class DepartmentNoticeRepository {
    DepartmentNoticeContract.Presenter presenter;
    Context context;

    public DepartmentNoticeRepository(DepartmentNoticeContract.Presenter presenter, Context context) {
