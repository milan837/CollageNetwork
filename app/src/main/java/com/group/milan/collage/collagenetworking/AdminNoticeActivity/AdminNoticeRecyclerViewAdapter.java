...
public class AdminNoticeRecyclerViewAdapter extends RecyclerView.Adapter<AdminNoticeRecyclerViewAdapter.MyViewHolder> {
    Context context;
    List<Response> list;

    public AdminNoticeRecyclerViewAdapter(Context context, List<Response> list) {
